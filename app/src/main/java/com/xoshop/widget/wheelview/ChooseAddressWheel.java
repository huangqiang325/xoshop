package com.xoshop.widget.wheelview;
...
import com.xoshop.R;
import com.xoshop.comm.bean.wheelbean.AddressDtailsEntity;
import com.xoshop.utils.SysUtils;
import com.xoshop.widget.wheelview.listener.OnAddressChangeListener;
import com.xoshop.widget.wheelview.wheelAdapter.AreaWheelAdapter;
import com.xoshop.widget.wheelview.wheelAdapter.CityWheelAdapter;
import com.xoshop.widget.wheelview.wheelAdapter.ProvinceWheelAdapter;
...
public class ChooseAddressWheel implements MyOnWheelChangedListener {
    ...
    private void initView() {
        parentView = layoutInflater.inflate(R.layout.__layout_choose_city, null);
    ...
    private void initPopupWindow() {
        popupWindow = new PopupWindow(parentView, WindowManager.LayoutParams.MATCH_PARENT, (int) (SysUtils.getScreenHeight(context) * (2.0 / 5)));
