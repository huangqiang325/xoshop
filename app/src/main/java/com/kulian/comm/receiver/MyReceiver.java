package com.kulian.comm.receiver;
...
import com.kulian.utils.LocalBroadcastManager;
	...
	public void onReceive(Context context, Intent intent) {
		try {
			...
			if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
				...
				Log.d(TAG, "[MyReceiver] 用户点击打开了通知EXTRA_MESSAGE"+bundle.getString(JPushInterface.EXTRA_MESSAGE));
				Log.d(TAG, "[MyReceiver] 用户点击打开了通知EXTRA_TITLE"+bundle.getString(JPushInterface.EXTRA_TITLE));
				//打开自定义的Activity
...
//				context.startActivity(i);
	...
	//send msg to ChatActivity
	private void processCustomMessage(Context context, Bundle bundle) {
		if (HomePageActivity.isForeground) {
			String message = bundle.getString(JPushInterface.EXTRA_MESSAGE);
			String extras = bundle.getString(JPushInterface.EXTRA_EXTRA);
			Log.i(TAG,"processCustomMessage-->message"+message);
