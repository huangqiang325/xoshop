...
import com.kulian.widget.TimeRangePicker.data.Type;
import com.kulian.widget.TimeRangePicker.data.WheelCalendar;
import com.kulian.widget.TimeRangePicker.listener.OnDateSetListener;
...
public class DateScrollerDialog extends DialogFragment implements View.OnClickListener {
    ...
    private View initView() {
        ...
        View view = inflater.inflate(R.layout._timerangepicker_timepicker_layout, nullParent);
