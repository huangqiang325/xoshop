...
import static com.kulian.utils.FileUtil.getRealFilePathFromUri;
...
public class ClipViewLayout extends RelativeLayout {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        mHorizontalPadding = array.getDimensionPixelSize(R.styleable.ClipViewLayout_mHorizontalPadding,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, padd_hori, getResources().getDisplayMetrics()));
        //获取裁剪框边框宽度，默认1dp
